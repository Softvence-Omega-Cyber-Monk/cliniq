...
const navItems = [
  ...
  },
  {
    ...
    label: "Therapists",
    icon: Users,
    href: "/admin-dashboard/admin-therapists",
  },
  {
    id: 3,
    label: "Sessions",
    icon: Calendar,
    href: "/admin-dashboard/admin-sessions",
  },
  {
    id: 4,
    label: "Content Management",
    icon: FileText,
    href: "/admin-dashboard/admin-content",
  },
  {
    id: 5,
    label: "Reports",
  ...
  },
  {
    ...
    label: "Support",
    icon: HelpCircle,
    href: "/admin-dashboard/admin-support",
  },
];
        ...
        <>
          <Icon
            className={`w-5 h-5 transition-colors duration-200 ${
              isActive ? "text-white" : "text-[#575A62] group-hover:text-white"
            }`}
          />
