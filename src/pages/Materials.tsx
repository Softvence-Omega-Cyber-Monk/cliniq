...
const PLACEHOLDER_IMAGE_URL = 'https://placehold.co/800x400/F0F0F0/333333?text=Therapy+Session+Scene';
...
const MaterialCard: React.FC<{ material: Material; onView: (id: number) => void }> = ({ material, onView }) => (
...
const MaterialDetailView: React.FC<{ material: Material; onBack: () => void }> = ({ material, onBack }) => {
    ...
    const mockContent = (
      <div className="text-gray-700 space-y-6 text-sm sm:text-base leading-relaxed">
        <p>
          Cognitive Behavioral Therapy (CBT) is a structured, goal-oriented form of psychotherapy that focuses on the relationship between thoughts, feelings, and behaviors. It helps individuals identify and challenge negative thought patterns and beliefs, enabling them to develop healthier coping strategies. By addressing these cognitive distortions, CBT empowers clients to make positive changes in their lives, ultimately leading to improved emotional well-being and resilience.
        </p>
        <p>
          Cognitive Behavioral Therapy (CBT) is a structured, goal-oriented form of psychotherapy that focuses on the relationship between thoughts, feelings, and behaviors. It helps individuals identify and challenge negative thought patterns and beliefs, enabling them to develop healthier coping strategies. By addressing these cognitive distortions, CBT empowers clients to make positive changes in their lives, ultimately leading to improved emotional well-being and resilience.
        </p>
        ...
        <div className="my-8 rounded-xl overflow-hidden shadow-lg border border-gray-200">
          <img 
            ...
            onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = 'https://placehold.co/800x400/F0F0F0/333333?text=Image+Load+Failed'; }}
          />
        </div>
        
        <p>
          Cognitive Behavioral Therapy (CBT) is a structured, goal-oriented form of psychotherapy that focuses on the relationship between thoughts, feelings, and behaviors. It helps individuals identify and challenge negative thought patterns and beliefs, enabling them to develop healthier coping strategies. By addressing these cognitive distortions, CBT empowers clients to make positive changes in their lives, ultimately leading to improved emotional well-being and resilience. Cognitive Behavioral Therapy (CBT) is a structured, goal-oriented form of psychotherapy that focuses on the relationship between thoughts, feelings, and behaviors. It helps individuals identify and challenge negative thought patterns and beliefs, enabling them to develop healthier coping strategies. By addressing these cognitive distortions, CBT empowers clients to make positive changes in their lives, ultimately leading to improved emotional well-being and resilience.
        </p>
        <p>
          By addressing these cognitive distortions, CBT empowers clients to make positive changes in their lives, ultimately leading to improved emotional well-being and resilience. Cognitive Behavioral Therapy (CBT) is a structured, goal-oriented form of psychotherapy that focuses on the relationship between thoughts, feelings, and behaviors. It helps individuals identify and challenge negative thought patterns and beliefs, enabling them to develop healthier coping strategies.
        </p>
      </div>
    );
    ...
    return (
      <div className="bg-white min-h-screen p-4 sm:p-10 rounded-xl shadow-lg border border-gray-100">
        ...
        <div className="text-sm mb-6 flex items-center text-gray-500">
          <button onClick={onBack} className="hover:text-teal-600 transition duration-150">
            Materials
          </button>
...
export default function App() {
  ...
  const [selectedMaterialId, setSelectedMaterialId] = useState<number | null>(null); // State for detail view
  ...
  const filteredMaterials = useMemo(() => {
    return MOCK_MATERIALS.filter(material => {
      ...
      const matchesCategory = 
        ...
        material.tags.some(tag => tag.text.toLowerCase() === selectedCategory.toLowerCase());
  ...
  const categories = useMemo(() => {
    ...
    const primaryTags = allTags.filter(tag => !['Active', 'PDF', 'Video', 'worksheet'].includes(tag));
