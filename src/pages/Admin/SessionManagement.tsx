    ...
    <div>
      ...
      <div className="mb-6 flex items-center gap-4">
        <div className="flex-1 relative bg-white ">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-200 bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-teal-500"
          />
        </div>
        ...
        <div className="flex gap-4">
          <div className="relative">
            <select
              ...
              className="appearance-none px-4 py-2 rounded-lg bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-teal-500 pr-8 bg-white border border-gray-200"
            >
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none px-4 py-2 rounded-lg border border-gray-200 bg-white text-foreground focus:outline-none focus:ring-2 focus:ring-teal-500 pr-8"
            >
      ...
      <div className="space-y-2">
        {sessions.map((session) => (
          <div
            key={session.id}
            className="flex items-center justify-between p-4 rounded-lg border bg-card hover:bg-card/80 transition-colors bg-white border-gray-200"
          >
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4 text-sm text-muted-foreground">
                <div className="flex items-center gap-1 text-[#7E8086]">
