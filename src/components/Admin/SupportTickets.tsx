...
export default function AdminSupportTickets() {
  ...
  // RTK Query hooks
  const { data: ticketsData, isLoading: ticketsLoading } = useGetAllTicketsQuery({
            ...
            <tbody className="divide-y divide-border">
              {ticketsLoading ? (
                ...
                ticketsData?.tickets.map((ticket) => (
                  <tr key={ticket.id} className="hover:bg-muted/30 transition-colors border-b border-gray-200">
                    ...
                    <td className="px-6 py-4 text-sm text-foreground border-t border-gray-200">
                      {ticket.clinic?.fullName || ticket.therapist?.fullName || "Unknown"}
                    </td>
                    <td className="px-6 py-4 text-sm text-foreground border-t border-gray-200">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                <p className="text-sm">
                  ...
                  {selectedTicket.clinic?.fullName || selectedTicket.therapist?.fullName}
                </p>
                <p className="text-sm">
                  <span className="font-semibold">Email:</span>{" "}
                  {selectedTicket.clinic?.email || selectedTicket.therapist?.email}
                </p>
                <p className="text-sm">
                  <span className="font-semibold">Type:</span> {selectedTicket.ownerType}
                </p>
                <p className="text-sm">
              ...
              {/* Conversation Thread */}
              <div>
                <h3 className="font-semibold text-foreground mb-3">Conversation</h3>
              ...
              <div className="flex gap-3 justify-end pt-4 border-t">
                ...
                >
                  {sendingMessage && <Loader2 className="animate-spin" size={16} />}
                  Send Reply
                </button>
              </div>
            </div>
