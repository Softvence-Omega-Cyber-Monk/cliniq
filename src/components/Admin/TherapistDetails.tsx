...
export default function TherapistDetails({ therapistId, onBack }: TherapistDetailsProps) {
  // Mock therapist data
  const therapist = {
    id: therapistId,
  ...
  return (
    <div>
      <button onClick={onBack} className="flex items-center gap-2 text-teal-600 hover:text-teal-700 mb-6 font-medium">
      ...
      <div className="bg-card rounded-lg border border-border p-6">
        ...
        <div className="flex items-start justify-between mb-6">
          ...
          <div className="flex gap-3">
            <button className="px-4 py-2 rounded-lg bg-slate-700 text-white font-medium hover:bg-slate-800 transition-colors">
              Suspend
            </button>
